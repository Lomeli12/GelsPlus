...
public class EntityGelThrowable extends EntityThrowable {
    public static ItemStack blockCheck = new ItemStack(Block.stone);
        ...
        if (pos.entityHit != null) {
            ...
            if (this.gelBlock > -1) {
                ...
                if (this.gelBlock < GelRegistry.INSTANCE().getRegistry().size()) {
                    GelRegistry.INSTANCE().getGel(this.gelBlock).gelThrownEffect(this.worldObj, x, y, z, pos.entityHit, doEffect);
                    if ((pos.entityHit instanceof EntityLivingBase) && GelRegistry.INSTANCE().getGel(this.gelBlock).canColor()
                            && GelsPlus.gelEffects) {
