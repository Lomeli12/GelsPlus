...
public abstract class GelAbility {
    /**
     * Use this to register your gels. </p>
     * Example:</br>
     * gelRegistry.addGel(new GelCustom());
     */
    ...
    /**
     * Items used in the gel's shapeless recipe (8 items max). If you want a fluid container in the recipe, use <i>fluid$</i> plus the fluid's name as it is registered in the Fluid Registry.
     * <p>Examples:
     * <br>For Water containers (Water Bucket, Water Bottles, etc)
     * <br><i>return new Object[] { "fluid$water" };</i>
     * <br>For Lava containers (Lava Bucket, Lava Capsules, Lava Cells, etc)
     * <br><i>return new Object[] { "fluid$lava" };</i>
     * <br>Basic recipe
     * <br><i>return new Object[] { Items.slime_ball, "fluid$water" };</i>
     *
     * @return
     */
    ...
    /**
     * Get the name of the gel here. If doing localizations, place the unlocalized name of the gel here.
     *
     * @return
     */
